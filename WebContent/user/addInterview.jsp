...
<input name="method" value="insertInterview" type="hidden" /> 
	<input name="rid" value="<%=userID%>" type="hidden" /><br /> 
	<input name="cid" value="${cv.cid}" type="hidden" /><br /> 
<h2 id="h2">create a new Interview</h2>
	<HR style="FILTER: alpha(opacity=100,finishopacity=0,style=1); margin-left: 50" width="70%" color=#987cb9 SIZE=3>
	...
	<tr>
		<th>date</th>
		<td>
		<input style="width: 120px;" type="text" name="date" id="date"/>
